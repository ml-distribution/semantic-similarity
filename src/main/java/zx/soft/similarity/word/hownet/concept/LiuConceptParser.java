...
import zx.soft.similarity.word.hownet.sememe.LiuqunSememeParser;
import zx.soft.similarity.word.hownet.sememe.SememeParser;
...
public class LiuConceptParser extends ConceptParser {
	...
	protected double calculate(double sim_v1, double sim_v2, double sim_v3, double sim_v4) {
		return beta1 * sim_v1 + beta2 * sim_v1 * sim_v2 + beta3 * sim_v1 * sim_v2 * sim_v3 + beta4 * sim_v1 * sim_v2
				* sim_v3 * sim_v4;
	}
